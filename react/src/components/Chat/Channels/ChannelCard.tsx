...
export function ChannelCard({
  ...
  return (
    <div
      ...
      } hover:bg-gray-500 hover:text-white text-left shadow`}
    >
      <span
        onClick={setActiveChannel}
        className={`${
          !joinable && "cursor-pointer"
        } flex flex-row items-center mx-3 text-xl overflow-hidden break-words inline-flex`}
      >
